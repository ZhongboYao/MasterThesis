...
def add_chunk(collection_name, chunk):
...
def add_caption(collection_name, image):
...
def add_image(collection_name, image):
    ...
    image_content = Image.open(image.image_path)
    image_embedding = model.encode(image_content)
